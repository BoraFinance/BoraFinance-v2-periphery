...
enum RouterVersion {
  BoraFinanceV2Router01 = 'BoraFinanceV2Router01',
  BoraFinanceV2Router02 = 'BoraFinanceV2Router02'
}

describe('BoraFinanceV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.BoraFinanceV2Router01]: fixture.router01,
        [RouterVersion.BoraFinanceV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.BoraFinanceV2Router01]: 101876,
              [RouterVersion.BoraFinanceV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.BoraFinanceV2Router01]: 138770,
              [RouterVersion.BoraFinanceV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
